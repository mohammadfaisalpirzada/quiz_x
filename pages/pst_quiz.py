...
# Set page config
st.set_page_config(
    page_title="Pakistan Studies Quiz",
    layout="wide",
...
def main():
    ...
    if st.session_state.page == 'intro':
        st.markdown('<h2 style="text-align:center; color:#1e88e5; margin-bottom:20px;">Pakistan Studies Quiz Test</h2>', unsafe_allow_html=True)
            ...
            with col1:
                if st.button("Start Quiz"):
                    if not roll_num or not std_name or not f_name:
                        ...
                        quiz_data = load_quiz_data("pst_quiz.xlsx", "table (2)")
